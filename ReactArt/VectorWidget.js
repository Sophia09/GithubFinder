...
export default class VectorWidget extends Component {
    ...
    render() {
        return(
            <Surface
                ...
                height={700}
            >
                {this.renderGraphics(this.state.degrees)}
            </Surface>
        );
    }

    renderGraphics(rotation) {
       return(
           <Group>
               <Group x={210} y={135}>

                   <Shape fill='rgba(0, 0, 0, 1)' d={BORDER_PATH} />
                   ...
                   <Group x={55} y={29}>
                       <Group rotation={rotation} originX={84} originY={89}>
                           <Shape fill='#FFF' d={CENTER_DOT_PATH} />
                           <Group>
                               <Shape d={RING_ONE_PATH} stroke='#FFF' strokeWidth={8} />
                               <Shape d={RING_TWO_PATH} transform={RING_TWO_ROTATE} stroke='#FFF' strokeWidth={8} />
